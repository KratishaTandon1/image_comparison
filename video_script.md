...
*Read this script at a steady, natural pace. Record your screen showing the [q1_leaderboard_mockup.html](file:///c:/Users/prakh/Downloads/josh/q1_leaderboard_mockup.html) and your report files.*
...
Kirana stores represent over 90% of India's retail, and local shop owners increasingly use AI to create flyers for WhatsApp Statuses. I evaluated how Google Gemini 3.1, DALL-E 3, and Gemini 2.5 perform on Hindi and English text integration and cultural accuracy."
...
"To prevent this, my recommendation for the engineering team is to block users whose **Rushed Trivial rate** exceeds 30%. We should calculate their **Actual Typing Speed** as `edit_distance / time_taken`. If this exceeds 25 characters per second, it is a bot-paste, and we should instantly block them.
