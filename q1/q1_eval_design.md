...
* **The Technical Challenge**: Standard global text-to-image models (DALL-E 3, Midjourney) fail to capture the specific visual aesthetics of Indian daily life (e.g. correct shape of laddoos, shape of clay lamps/diyas) and consistently distort Devanagari text.
...
* `/q1/images/g31_diwali.png`, `dalle_diwali.png`, `g25_diwali.png`
* `/q1/images/g31_chai.png`, `dalle_chai.png`, `g25_chai.png`
* `/q1/images/g31_samosa.png`, `dalle_samosa.png`, `g25_samosa.png`
