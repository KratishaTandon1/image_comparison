# Consent Proof & Form Documentation

This document outlines the consent collection process and the verified responses from the 8 participants who rated the images for the Question 1 Text-to-Image evaluation.

---

## 1. Consent Collection Method
Consent was collected directly from participants via verified digital messaging (WhatsApp). Each participant was sent the formal consent text template, filled in their name and email, and replied to confirm agreement. 

*Screenshots of the verified message logs are held as proof of generation and consent verification.*

---

## 2. Consent Statement (Confirmed by all Raters)
...
## 3. Rater Consent Verification Log
