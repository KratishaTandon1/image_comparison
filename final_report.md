...
`q1/images/g31_diwali.png`, `gpt_image_1_diwali.png`, `g25_diwali.png` (and similarly for Chai and Samosa prompts).
...
* **OpenAI GPT Image 1** is the market leader for **text rendering** (clean Devanagari script). However, it suffered from "Western bias": sweets looked like round cookies/candies, and store layouts felt too clean and supermarket-like rather than an authentic Indian Kirana.
...
4. **What did you learn from running the sample?**
   I learned that OpenAI GPT Image 1 is highly capable of rendering Devanagari text, but lacks cultural training. Conversely, Google's Gemini 3.1 Flash Preview has excellent cultural details but still occasionally distort Devanagari text.
